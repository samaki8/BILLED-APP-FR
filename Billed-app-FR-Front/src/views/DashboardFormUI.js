//Billed-app-FR-Front\src\views\DashboardFormUI.js
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" data-toggle="modal">
          <div class="row">
            <div class="col-sm-12">
              ${bill.fileUrl ?
    `<img width="100%" src=${bill.fileUrl} alt="Bill" />` :
      ...
      <div class="row">
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <span id="file-name-admin">${getFileName(bill.fileName)}</span>
